...
# Tworzy quiz wraz z pytaniami i opdowiedziami
# ułożonymi w losowej kolejności wraz z odpowiedziami

# The quiz data, keys are states and values are capitals
# To są dane quizu. Klucze to nazwy stanów, natomist warości to ich stolice
...
for quizNum in range(35):
    ...
    for questionNum in range(50):
        ...
        # Przygotowanie prawidłowych i złych odpowiedzi
